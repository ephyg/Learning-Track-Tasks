...
const JobDetail = async ({ params }: Jobparams) => {
  ...
  return (
    <>
      <NavBar />
      <div className="flex flex-col md:flex-row px-4 md:px-8 py-24 gap-8">
        <div className="flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="text-headertext2 font-poppins900">
              Responsibilities
            </h1>
                ...
                <div className="">
                  ...
                  <div className="flex gap-3">
                    {jobDetail.location.map((loc, index) => (
                      <p className="font-epilogue600 font-epilogue" key={index}>
                        {loc}
                      </p>
                    ))}
                  </div>
